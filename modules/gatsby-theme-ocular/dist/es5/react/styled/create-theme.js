...
function createTheme(primitives) {
  return {
    ...
    typography: {
      font100: "normal 11px/16px ".concat(primitives.primaryFontFamily),
      font200: "normal 12px/20px ".concat(primitives.primaryFontFamily),
      font250: "bold 12px/20px ".concat(primitives.primaryFontFamily),
      font300: "normal 14px/20px ".concat(primitives.primaryFontFamily),
      font350: "bold 14px/20px ".concat(primitives.primaryFontFamily),
      font400: "normal 16px/24px ".concat(primitives.primaryFontFamily),
      font450: "bold 16px/24px ".concat(primitives.primaryFontFamily),
      font500: "bold 20px/28px ".concat(primitives.primaryFontFamily),
      font600: "bold 24px/36px ".concat(primitives.primaryFontFamily),
      font700: "bold 32px/48px ".concat(primitives.primaryFontFamily),
      font800: "bold 40px/56px ".concat(primitives.primaryFontFamily),
      font900: "bold 52px/68px ".concat(primitives.primaryFontFamily),
      font1000: "normal 72px/96px ".concat(primitives.primaryFontFamily),
      font1100: "normal 96px/116px ".concat(primitives.primaryFontFamily)
    },
    sizing: {
      scale0: '2px',
      scale100: '4px',
