...
var DocsHeader = function (_Component) {
  (0, _inherits2.default)(DocsHeader, _Component);
  ...
  function DocsHeader(props) {
    ...
    (0, _classCallCheck2.default)(this, DocsHeader);
  ...
  (0, _createClass2.default)(DocsHeader, [{
    key: "renderHeader",
    value: function renderHeader() {
      var links = this.state.links;
      return _react.default.createElement(_header.default, (0, _extends2.default)({
        links: links
      }, this.props));
    }
  }, {
...
DocsHeader.propTypes = _header.propTypes;
