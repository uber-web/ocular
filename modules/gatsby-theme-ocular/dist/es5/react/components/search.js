...
var SearchIcon = function (_Component) {
  (0, _inherits2.default)(SearchIcon, _Component);

  var _super = _createSuper(SearchIcon);

  function SearchIcon() {
    (0, _classCallCheck2.default)(this, SearchIcon);
    return _super.apply(this, arguments);
  }

  (0, _createClass2.default)(SearchIcon, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("svg", (0, _extends2.default)({
        viewBox: "0 0 24 24"
      }, this.props), _react.default.createElement("title", null, "Search"), _react.default.createElement("path", {
        fillRule: "evenodd",
        clipRule: "evenodd",
