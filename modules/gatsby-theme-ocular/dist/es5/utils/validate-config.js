...
module.exports = function validateConfig(config, constraints) {
  ...
  var allMessages = [].concat((0, _toConsumableArray2.default)(unusedProperties.map(function (key) {
    return "".concat(key, " is not used in the gatsby config.");
  })), (0, _toConsumableArray2.default)(deprecatedProperties.map(function (key) {
    return "".concat(key, " will be deprecated soon.");
  })), (0, _toConsumableArray2.default)(Object.keys(messages).map(function (key) {
