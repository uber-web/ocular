"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var validateConfig;module.link('../../src/utils/validate-config',{default(v){validateConfig=v}},1);var CONFIG_SCHEMA;module.link('../../src/gatsby-config/config-schema',{default(v){CONFIG_SCHEMA=v}},2);/* eslint-disable max-len */
