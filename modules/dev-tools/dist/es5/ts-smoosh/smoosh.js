...
function enrichJs(jsFile, dts) {
  ...
  var transformer = function transformer(context) {
    ...
    return function (rootNode) {
      ...
      return ts.factory.updateSourceFile(newRoot, [].concat((0, _toConsumableArray2.default)(dts.imports), (0, _toConsumableArray2.default)(importsForTypes), (0, _toConsumableArray2.default)(dts.typeAliases), (0, _toConsumableArray2.default)(newRoot.statements)));
    };
  };
